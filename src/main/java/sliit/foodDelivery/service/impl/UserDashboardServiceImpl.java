...
public class UserDashboardServiceImpl implements UserDashboardService {
    ...
    // READ: Get user dashboard statistics
    @Override
    public UserDashboardStatsDto getStats(Long userId) {
        ...
        // READ: Count orders this month and last month
        ...
        // READ: Get saved addresses and recent addresses
        ...
        // READ: Get delivered and active orders
